...
Weitere Informationen zur Produktkompatibilität finden [ in der Entwicklerdokumentation ](https://experienceleague.adobe.com/en/docs/commerce-operations/release/product-availability).
...
- [Aktivieren](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-commerce) Adobe Commerce als Ziel in Real-Time CDP
...
1. [Melden Sie sich bei ](https://experienceleague.adobe.com/en/docs/commerce/user-guides/integration-services/saas#organizationid) Adobe-Konto an und wählen Sie Ihre Organisations-ID aus.

1. Navigieren Sie in _Admin_-Seitenleiste zu **[!UICONTROL System]** > _[!UICONTROL Services]_>**[!UICONTROL [!DNL Data Connection]]**.

1. Fügen Sie im Feld **[!UICONTROL Datastream ID]** die ID des Datenstroms ein, den Sie beim Aktivieren [ Adobe Commerce ](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-commerce#parameters) Ziel in Real-Time CDP erstellt haben.

   Dieser Datenstrom sendet Daten von Ihrer Commerce-Website an Real-Time CDP, um festzustellen, ob ein Erstkäufer zu einer Zielgruppe gehört. Wenn Sie noch keinen Datenstrom erstellt haben, [ Sie ](https://experienceleague.adobe.com/en/docs/experience-platform/datastreams/configure#create) Datenstrom in Experience Platform [hinzufügen](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/adobe-commerce) zum Commerce-Ziel in Real-Time CDP und zur [[!DNL Data Connection]](https://experienceleague.adobe.com/en/docs/commerce/data-connection/fundamentals/connect-data#data-collection)-Erweiterung in der Admin.

   >[!NOTE]
   >
   >Wenn Sie eine Datenstrom-ID angeben[ verknüpfen Sie sie mit einer bestimmten Website ](https://experienceleague.adobe.com/en/docs/commerce/data-connection/fundamentals/connect-data#data-collection) der [!DNL Data Connection]. Wenn Ihr Commerce-Store über mehrere Websites verfügt[ erstellen Sie ](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/ui/connect-destination) für jede Website in Real-Time CDP ein Ziel und verwenden Sie für jede eine andere Datenstrom-ID.

1. Navigieren Sie in _Admin_-Seitenleiste zu **[!UICONTROL Stores]** > _[!UICONTROL Settings]_>**[!UICONTROL Configuration]**.

1. Erweitern Sie **[!UICONTROL Services]** und wählen Sie **[!UICONTROL [!DNL Data Connection]]**.

1. [Hinzufügen](https://experienceleague.adobe.com/en/docs/commerce/data-connection/fundamentals/connect-data#add-service-account-and-credential-details) Details zum Service-Konto und den Anmeldedaten.
...
Sie können alle [aktiven](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/ui/activate/activate-edge-personalization-destinations) Zielgruppen anzeigen, die in Ihrer Adobe Commerce-Instanz mithilfe des Dashboards **Real-Time CDP-Zielgruppen** personalisiert werden können.
...
Informationen zum Erfassen dieser Segmentzugehörigkeiten aus der SDK finden Sie in diesem [Code-Snippet](https://experienceleague.adobe.com/en/docs/experience-platform/destinations/catalog/personalization/custom-personalization#example-response-for-custom-personalization-with-attributes).
...
1. [Installieren und konfigurieren Sie die SDK für Ihre mobile Commerce-Site](https://experienceleague.adobe.com/en/docs/commerce/data-connection/fundamentals/mobile-sdk-epc).
...
1. [Erneutes ](https://experienceleague.adobe.com/en/docs/experience-platform/landing/platform-apis/api-authentication#generate-access-token) des Zugriffstokens in der Konsole.
