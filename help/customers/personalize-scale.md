...
1. [Datenverbindung](https://experienceleague.adobe.com/de/docs/commerce/data-connection/overview): Geben Sie Storefront-, Back-Office- und Kundenprofildaten aus Adobe [!DNL Commerce] an das Adobe Experience Platform Edge Network weiter, um sie in allen Adobe Experience Cloud-Programmen zu verwenden, einschließlich:
   ...
   - [Adobe [!DNL Journey Optimizer]](https://experienceleague.adobe.com/de/docs/journey-optimizer/using/get-started/essentials/get-started): Starten Sie personalisierte Omni-Channel-Journey, einschließlich E-Mail-Kampagnen, SMS, Push-Benachrichtigungen und mehr.
   - [Customer Journey Analytics](https://experienceleague.adobe.com/de/docs/analytics-platform/using/cja-overview/cja-b2c-overview/cja-overview) und [Adobe [!DNL Analytics]](https://experienceleague.adobe.com/de/docs/analytics/analyze/admin-overview/analytics-overview): Gewinnen Sie Einblicke in den Kunden und das Unternehmen.
