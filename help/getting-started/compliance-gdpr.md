...
- Datenflussdiagramme und die Datenbankentitätszuordnung finden Sie unter [Referenz zu personenbezogenen Informationen](https://experienceleague.adobe.com/en/docs/commerce-operations/security-and-compliance/reference/data-m2){: target="_blank"}.
