...
|----------------|-----------|-------|
| 2.4.7-p4 und höher -p Versionen | 1,2,0 | Unterstützung für 2.4.7-P4 erfordert einen [Hotfix](https://experienceleague.adobe.com/en/docs/experience-cloud-kcs/kbarticles/ka-27147) |
