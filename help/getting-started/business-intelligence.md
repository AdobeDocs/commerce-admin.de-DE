...
* [[!DNL Commerce] crontab](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cli/configure-cron-jobs) wird erstellt und Cron-Aufträge werden auf dem installierten Server ausgeführt.
