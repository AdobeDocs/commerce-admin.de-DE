...
<tr>
  <td valign="top">
   ...
   <td valign="top"><a href="https://experienceleague.adobe.com/docs/commerce-admin/b2b/guide-overview.html?lang=de"><strong>Adobe Commerce B2B</strong></a>
...
<tr>
   ...
   <td valign="top"><a href="https://experienceleague.adobe.com/docs/commerce-admin/page-builder/guide-overview.html?lang=de"> <strong>[!DNL Page Builder]</strong></a>
...
>[!TIP]
>
>Sie können auch [Neue Funktionen in der Dokumentation zu Commerce Services](https://experienceleague.adobe.com/docs/commerce/user-guides/home.html?lang=de#what%E2%80%99s-new) und &quot;[ Funktionen in den Betriebshandbüchern“ ](https://experienceleague.adobe.com/docs/commerce-operations/operational-guides/home.html?lang=de#what%E2%80%99s-new).

| Beschreibung | Typ | Datum |
| ----------- | ---- | ---- |
| **1.4.0 B2B-Version** - In den Adobe Commerce B2B-Versionshinweisen werden Änderungen und Ergänzungen in Version [1.4.0 ](../b2b/release-notes.md#b2b-v140). | Aktualisieren | 06/13/23 |
...
| Version **2.4.6** - Die [B2B-Versionshinweise](../b2b/release-notes.md) wurden mit einer beschreibenden Liste von Fehlerbehebungen aktualisiert, die in der neuesten Erweiterungsversion (v1.3.5) enthalten sind. | Aktualisieren | 03/14/23 |
| **Neues Thema** - Das Thema [Zielgruppenaktivierung](../getting-started/commerce-account-transfer.md) wurde zum _Handbuch für das Kundenmanagement_ hinzugefügt, das detaillierte Informationen zum Aktivieren von Real-Time CDP-Zielgruppen in Adobe Commerce enthält. | Neu | 03/13/23 |
| **Neues Thema** - Das Thema [Commerce-Konto übertragen](../getting-started/commerce-account-transfer.md) wurde zum Handbuch _Erste Schritte“_. | Neu | 02/27/23 |
