...
MCOM bietet umfangreiche Funktionen und Services für erweiterte Omni-Channel-Auftragsverwaltung, globale Inventarisierung und Multi-Sourcing, Store-to-Warehouse-Erfüllung und zentralisierten Kundenservice. Eine vollständige Liste der Funktionen finden Sie in der [MCOM-Funktionsliste](https://commerce-docs.github.io/oms-documentation-archive/getting-started/feature-list/).
