...
description: Versionshinweise  [!DNL Inventory Management]  neue Funktionen, Fehlerbehebungen und bekannte Probleme in jeder Version des Community Engineering-Moduls.
...
[Versionsplan](https://experienceleague.adobe.com/en/docs/commerce-operations/release/planning/schedule){target="_blank"} für unterstützte und kompatible Versionen.
...
[!DNL Inventory Management] 1.2.6 (Modulversion: `magento/inventory-metapackage = 1.2.6`) wird mit Version 2.4.6 unterstützt und ist mit Version 2.4.0 von Adobe Commerce, Adobe Commerce on Cloud Infrastructure und der Magento Open Source-Code-Basis kompatibel.
...
[!DNL Inventory Management] 1.2.5 (Modulversion: `magento/inventory-metapackage = 1.2.5`) wird mit Version 2.4.5 unterstützt und ist mit Version 2.4.0 von Adobe Commerce, Adobe Commerce on Cloud Infrastructure und der Magento Open Source-Code-Basis kompatibel.
...
![Problem behoben](../assets/fix.svg) <!--- ACP2E-322--> Konfigurierbare Produkte werden jetzt an die letzte Position in der Produktliste verschoben, nachdem der Lagerbestand aktualisiert wurde, wenn die **[!UICONTROL Move out of stock to the bottom]** aktiviert ist. Eine neue benutzerdefinierte Datenbankabfrage wird implementiert, um die Elasticsearch-Indexsortierreihenfolge zu negieren, was die Admin-fähige Sortierreihenfolge ignoriert. Zuvor wurden konfigurierbare Produkte und ihre untergeordneten Produkte nicht an das Ende der Liste verschoben, wenn diese Einstellung aktiviert war.

## v1.2.4

Inventory management 1.2.4 (Modulversion: `magento/inventory-metapackage = 1.2.4`) wird mit Version 2.4.4 unterstützt und ist mit Version 2.4.0 von Adobe Commerce, Adobe Commerce on Cloud Infrastructure und der Magento Open Source-Code-Basis kompatibel.
...
[!DNL Inventory Management] 1.2.2 (Modulversion: `magento/inventory-metapackage = 1.2.2`) wird mit Version 2.4.2 unterstützt und ist mit Version 2.4.0 von Adobe Commerce, Adobe Commerce on Cloud Infrastructure und der Magento Open Source-Code-Basis kompatibel.
...
[!DNL Inventory Management] 1.2.1 (Modulversion: `magento/inventory-metapackage = 1.2.1`) wird mit Version 2.4.1 unterstützt und ist mit Version 2.4.0 von Adobe Commerce, Adobe Commerce on Cloud Infrastructure und der Magento Open Source-Code-Basis kompatibel.
...
![Bekanntes Problem](../assets/bug.svg) Bekanntes Problem mit Magento Open Source und Adobe Commerce v2.3.1 - Bei der asynchronen Datenmigration zwischen Quellen treten Probleme aufgrund von Änderungen an asynchronen APIs auf, deren Themennamen PHP-Klassen- und Methodennamen widerspiegeln. Es wird empfohlen, synchrone Vorgänge zu verwenden und **[!UICONTROL Run asynchronously]** auf `No` festzulegen.
