...
Die Einstellungen für _[!UICONTROL Advanced Pricing]_definieren die Bedingungen für spezielle Preise, die für eine bestimmte Kundengruppe oder einen freigegebenen Katalog verfügbar sind. Erweiterte Preise können auf einfache, virtuelle, herunterladbare und gebündelte Produkte angewendet werden. Verwenden Sie eine [Katalogpreisregel](../merchandising-promotions/price-rules-catalog.md), um ermäßigte Preise auf andere Produktarten anzuwenden. Weitere Informationen finden Sie unter [Preisumfang](catalog-price-scope.md).
...
![Adobe Commerce B2B](../assets/b2b.svg) (Nur mit [Adobe Commerce B2B](./b2b/../introduction.md) verfügbar) Wenn Sie freigegebene Kataloge verwenden, werden erweiterte Preisdaten sowohl mit Produktseiten als auch mit freigegebenen Katalogen synchronisiert. Wenn Sie beispielsweise eine Tier-Preismenge aktualisieren, aktualisiert das System den Wert im freigegebenen Katalog und auf der Produktseite. Alle benutzerdefinierten Preise, die im freigegebenen Katalog angegeben sind, haben Vorrang vor den Preisen für Kundengruppen. Weitere Informationen finden Sie unter [Festlegen der Preisstruktur und Struktur des freigegebenen Katalogs](https://experienceleague.adobe.com/docs/commerce-admin/b2b/shared-catalogs/define/catalog-shared-pricing-structure.html) im _Adobe Commerce B2B-Handbuch_.
...
| Posten | Beschreibung |
|----|-----------|
| [!UICONTROL Website] | Identifiziert die Website, auf der die Gruppenpreisregel gilt. Diese Option wird nur angezeigt, wenn die Installation über mehrere Websites verfügt. <br>**_Wichtig:_**Wählen Sie ALso_Website _in der Konfiguration [Katalogpreisumfang](catalog-price-scope.md) aus. Andernfalls werden die festgelegten erweiterten Preise für**alle **Websites angezeigt. |
...
| [!UICONTROL On Gesture] | Zeigt den tatsächlichen Produktpreis in einem Popup-Fenster als Antwort auf den Artikel _Preisklick_ oder _Was ist das?_ -Link. |
