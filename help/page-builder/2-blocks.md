...
1. Um Ihre API-Anmeldeinformationen zu konfigurieren, folgen Sie den [Anweisungen](https://developers.google.com/maps/documentation/javascript/get-api-key) in der [!DNL Google Maps].
