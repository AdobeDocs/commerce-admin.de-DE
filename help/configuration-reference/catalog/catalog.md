...
| [!UICONTROL Events to Scroll per Click in Event Slider Widget] | Store-Ansicht | Bestimmt die Anzahl der Ereignisse, die im Widget des Ereignisreglers auf CMS-Seiten wie der Startseite angezeigt werden. Verwenden Sie zum Außerkraftsetzen die Variable `scroll="x"` . |
