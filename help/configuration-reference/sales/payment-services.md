...
![Einstellungen für Kreditkartenfelder](assets/payments-ccfields-settings.png){zoomable: ja, width: 600px}
...
![PayPal-Zahlungsschaltflächen-Einstellungen](assets/payments-ppbuttons-settings.png){zoomable: ja, width: 600px}
