...
description: Überprüfen Sie die Konfigurationseinstellungen im Abschnitt [!UICONTROL PayPal Payments Advanced] auf der Seite [!UICONTROL Sales] &gt; [!UICONTROL Payment Methods] der Commerce Admin Console.
...
>Ab dem 14. September 2019 können europäische Banken Zahlungen ablehnen, die [PSD2}-](../../getting-started/compliance-payment-services-directive.md) nicht erfüllen. Um PSD2 zu erfüllen, müssen [!DNL PayPal Payments Advanced] in [!DNL Cardinal Commerce] integriert sein. Weitere Informationen finden Sie unter [3-D Secure for Payflow](https://developer.paypal.com/api/nvp-soap/payflow/3d-secure-overview/).
...
| [!UICONTROL Test Mode] | Website | Nach der Aktivierung führt PayPal Payments Advanced in einer Testumgebung aus. Deaktivieren Sie den Testmodus, wenn Sie im Produktionsmodus bereit für die Live-Schaltung sind. Optionen: `Yes` / `No` |
...
| [!UICONTROL Enable this Solution] | Website | Legt fest, ob PayPal Payments Advanced für Ihre Kunden als Zahlungsmethode verfügbar ist. |
...
![Grundeinstellungen](./assets/payment-methods-paypal-payments-advanced-basic-settings.png)<!-- zoom -->

| Feld | [Umfang](../../getting-started/websites-stores-views.md#scope-settings) | Beschreibung |
|--- |--- |--- |
| [!UICONTROL Title] | Shop-Ansicht | Ein Name, der PayPal Payments Advanced während des Checkouts als Zahlungsmethode identifiziert. |
| [!UICONTROL Sort Order] | Shop-Ansicht | Eine Zahl, die die Reihenfolge bestimmt, in der PayPal Payments Advanced angezeigt wird, wenn sie mit anderen Zahlungsmethoden beim Checkout aufgelistet wird. |
...
![PayPal Express Checkout - Grundeinstellungen](./assets/payment-methods-paypal-advanced-express-checkout-basic-settings.png)<!-- zoom -->
...
![Erweiterte Einstellungen für den PayPal Express-Checkout](./assets/payment-methods-paypal-payments-advanced-express-checkout-advanced.png)<!-- zoom -->
