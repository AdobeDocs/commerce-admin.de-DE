...
description: Überprüfen Sie die Konfigurationseinstellungen auf der Seite [!UICONTROL Sales] &gt; [!UICONTROL Sales Emails] des Commerce-Administrators.
...
|--- |--- |--- |
| [!UICONTROL Asynchronous sending] | Global | Bestimmt, ob Verkaufs-E-Mails asynchron gesendet werden. Es wird empfohlen, den asynchronen Versand zu aktivieren. Optionen: <br/>**`Disable`**- (Standard) E-Mails zum Verkauf werden gesendet, wenn sie durch ein Ereignis ausgelöst werden.<br/>**`Enable`** - (Empfohlen) Verkaufs-E-Mails werden in vorbestimmten, regelmäßigen Abständen gesendet. |
...
| [!UICONTROL New Order Confirmation Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
| [!UICONTROL Order Comment Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
| [!UICONTROL Invoice Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
| [!UICONTROL Invoice Comment Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
| [!UICONTROL Shipment Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
| [!UICONTROL Shipment Comment Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
| [!UICONTROL Credit Memo Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
![Kommentaren zu Credit Memo](./assets/sales-emails-credit-memo-comments.png)<!-- zoom -->
...
| [!UICONTROL Credit Memo Comment Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `Sales Representative` |
...
![Bestellung bereit für Abholung im Store](./assets/sales-emails-ready-pickup.png)<!-- zoom -->
...
| [!UICONTROL Order Ready For Pickup Email Sender] | Store-Ansicht | Identifiziert den Store-Kontakt, der als Absender der Nachricht angezeigt wird. Standardsender: `General Contact` |
...
| Bestellung bereit zum Abruf der E-Mail-Kopie an senden | Store-Ansicht | Gibt die E-Mail-Adresse eines Benutzers an, der eine Kopie der E-Mail &quot;_Bestellbereit für Abruf_&quot;erhält. Trennen Sie mehrere Adressen durch Kommas. |
...
![Genehmigung der Bestellung](./assets/sales-emails-purchase-order-approval.png)<!-- zoom -->
...
| [!UICONTROL RMA Email Sender] | Store-Ansicht | Identifiziert den [Store contact](../../getting-started/store-details.md#store-email-addresses) , der als Absender der Nachricht angezeigt wird. Standardwert: `Sales Representative` |
| [!UICONTROL RMA Email Template] | Store-Ansicht | Bestimmt die [E-Mail-Vorlage](../../systems/email-templates.md) , die für die Benachrichtigung verwendet wird, die gesendet wird, wenn eine RMA für einen Kunden generiert wird. Standardvorlage: `New RMA` |
...
| [!UICONTROL RMA Authorization Email Sender] | Store-Ansicht | Identifiziert den [Store contact](../../getting-started/store-details.md#store-email-addresses) , der als Absender der Nachricht angezeigt wird. Standardwert: `Sales Representative` |
| [!UICONTROL RMA Authorization Email Template] | Store-Ansicht | Bestimmt die [E-Mail-Vorlage](../../systems/email-templates.md) , die beim Senden einer RMA-Autorisierungsbenachrichtigung verwendet wird. Standardvorlage: `RMA Authorization` |
...
| [!UICONTROL RMA Comment Email Sender] | Store-Ansicht | Identifiziert den [Store contact](../../getting-started/store-details.md#store-email-addresses) , der als Absender der Nachricht angezeigt wird. Standardwert: `Sales Representative` |
| [!UICONTROL RMA Comment Email Template] | Store-Ansicht | Bestimmt die [E-Mail-Vorlage](../../systems/email-templates.md) , die verwendet wird, wenn ein Administrator einem RMA einen Kommentar für einen Kunden hinzufügt. Standardvorlage: `RMA Admin Comments` |
...
| [!UICONTROL RMA Comment Email Sender] | Store-Ansicht | Identifiziert den [Store contact](../../getting-started/store-details.md#store-email-addresses) , der als Absender der Nachricht angezeigt wird. Standardwert: `Customer Support` |
...
| [!UICONTROL RMA Comment Email Template] | Store-Ansicht | Bestimmt die [E-Mail-Vorlage](../../systems/email-templates.md) , die verwendet wird, wenn ein Kunde einem RMA einen Kommentar hinzufügt. Standardvorlage: `RMA Admin Comments` |
| [!UICONTROL Send RMA Comment Email Copy To] | Store-Ansicht | Gibt die E-Mail-Adresse eines Kontakts an, um eine Kopie der Benachrichtigung zu erhalten. Trennen Sie mehrere Adressen durch Kommas. |
| [!UICONTROL Send RMA Comments Email Copy Method] | Store-Ansicht | Gibt die zum Senden der Kopie verwendete E-Mail-Methode an. Zu den Optionen gehören: <br/>**`Bcc`**- Sendet eine blinde höfliche Kopie, indem der Empfänger in die Kopfzeile derselben E-Mail eingefügt wird, die an den Kunden gesendet wird. Der BCC-Empfänger ist für den Kunden nicht sichtbar.<br/>**`Separate Email`** - Sendet die Kopie als separate E-Mail. |
