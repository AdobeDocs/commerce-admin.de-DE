...
description: Überprüfen Sie die Konfigurationseinstellungen im Abschnitt [!UICONTROL PayPal Payflow Link] auf der Seite [!UICONTROL Sales] > [!UICONTROL Payment Methods] des Commerce Admin.
...
>Ab dem 14. September 2019 können europäische Banken Zahlungen ablehnen, die die [PSD2}-](../../getting-started/compliance-payment-services-directive.md) nicht erfüllen. Um PSD2 zu erfüllen, müssen [!DNL PayPal Payflow Link] mit [!DNL Cardinal Commerce] integriert sein. Weitere Informationen finden Sie unter [3-D Secure for Payflow](https://developer.paypal.com/api/nvp-soap/payflow/3d-secure-overview/).
