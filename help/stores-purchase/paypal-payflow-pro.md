...
>Ab dem 14. September 2019 können europäische Banken Zahlungen ablehnen, die [PSD2}-](../getting-started/compliance-payment-services-directive.md) nicht erfüllen. Um PSD2 zu erfüllen, muss PayPal Payflow Pro mit einem Drittanbieter-Plug-in integriert sein. Weitere Informationen finden Sie unter [3-D Secure for Payflow](https://developer.paypal.com/api/nvp-soap/payflow/3d-secure-mpi/).
...
- Wenn Sie mehrere Adobe Commerce- und Magento Open Source-Websites verwalten, müssen Sie für jede Website über ein separates PayPal-Händlerkonto verfügen.
...
1. **PayPal erhält die Transaktion** - Die Bestellinformationen werden an PayPal gesendet. Es wird ein Datensatz der Transaktion und eine Rechnung generiert. Sie können alle Payflow Pro Gateway-Transaktionen in Ihrem [PayPal-Händlerkonto][2] anzeigen.
...
1. Einrichten eines anderen Benutzers (empfohlen von PayPal):
   ...
   - Füllen Sie die erforderlichen Felder in den folgenden Abschnitten des _[!UICONTROL Add User]_Formulars aus:
...
1. Erweitern Sie **[!UICONTROL PayPal Payment Gateways]** (falls erforderlich) und klicken Sie zum **[!UICONTROL Payflow Pro]** auf **[!UICONTROL Configure]** .
