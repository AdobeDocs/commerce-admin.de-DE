...
- **USPS** - Im [USPS-Portal](https://developers.usps.com/) erfahren Sie, wie Sie Ihre Anmeldedaten für den Etikettendruck einrichten.
...
1. Wählen Sie **[!UICONTROL USPS Type]** als `USPS Rest APIs` oder `USPS Web Tools API` aus.
   ...
   >[!NOTE]
   >
   >USPS unterstützt die USPS Web Tools-API nicht mehr.
