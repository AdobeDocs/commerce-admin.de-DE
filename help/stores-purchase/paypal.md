...
>Ab dem 14. September 2019 können europäische Banken Zahlungen ablehnen, die [PSD2}-](../getting-started/compliance-payment-services-directive.md) nicht erfüllen. Bei den meisten PayPal-Lösungen ist keine Handlung erforderlich, um PSD2 einzuhalten, da diese Anforderungen von PayPal gehandhabt werden.
