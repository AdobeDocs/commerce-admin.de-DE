...
- Normalerweise sollten Sie die Daten beim Aktualisieren in Commerce neu indizieren.
...
- Bei neuen Commerce-Installationen müssen Sie den Cache leeren und die Neuindizierung durchführen.
...
1. Klicks **[!UICONTROL Submit]** , um die Änderung auf jeden ausgewählten Indexer anzuwenden.
   ...
   **Indexverwaltungsspalten**
   ...
   | [!UICONTROL Status] | Zeigt eine der folgenden Optionen an: <br/>**[!UICONTROL Ready]**— Der Index ist aktuell.<br/>**[!UICONTROL Scheduled]** - Die Neuindizierung ist geplant. <br/>**[!UICONTROL Running]**- Die Neuindizierung wird ausgeführt.<br/>**[!UICONTROL Reindex Required]** - Es wurde eine Änderung vorgenommen, die eine Neuindizierung erfordert, die Indexer jedoch nicht automatisch aktualisiert werden können. Überprüfen Sie, ob [cron](cron.md) ist verfügbar und korrekt konfiguriert. |
...
Commerce bietet zusätzliche Neuindizierungsoptionen über die Befehlszeile. Ausführliche Informationen und Befehlsoptionen finden Sie unter [Reindex](https://experienceleague.adobe.com/docs/commerce-operations/configuration-guide/cli/manage-indexers.html#reindex){:target=&quot;blank&quot;} im _Konfigurationshandbuch_.
