...
>[!NOTE]
> Adobe Commerce-Händler, die die Live-Suche, den Katalog-Service oder Produktempfehlungen verwenden, haben die Möglichkeit, einen [SaaS-basierten Preisindizer“ ](https://experienceleague.adobe.com//en/docs/commerce/price-indexer/price-indexing?lang=de) verwenden.
...
1. Legen Sie **[!UICONTROL Actions]** auf eine der folgenden Einstellungen fest:
   ...
   >[!IMPORTANT]
   >
   >Das Kundenraster kann nur mithilfe von `Update on Save` neu indiziert werden. Dieser Index unterstützt **_nicht_** `Update by Schedule`.
