...
**_Konfigurieren der maximalen Sitzungsgröße:_**
...
Technische Informationen finden Sie unter [Verwenden von Redis für &#x200B;](https://experienceleague.adobe.com/en/docs/commerce-operations/configuration-guide/cache/redis/redis-session) Sitzungsspeicherung) im _Konfigurationshandbuch_.
...
**_Anpassen der Lebensdauer von Admin-Sitzungen:_**
