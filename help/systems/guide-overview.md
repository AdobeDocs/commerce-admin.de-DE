...
| [Datenübertragung](data-transfer.md) | <ul><li>Mit den Import- und Export-Tools können Sie mehrere Datensätze in einem Vorgang verwalten. Sie können nicht nur neue Artikel importieren, sondern auch vorhandene Produktsätze aktualisieren, ersetzen und löschen.</li><li>Zeigen Sie Produktdaten an, die im [[!UICONTROL Data Management Dashboard]](data-dashboard.md) in Commerce SaaS-Services veröffentlicht wurden.</li><li>Überwachen Sie die Synchronisierung von Datenexport-Feeds mit der Commerce SaaS-Service-Datenbank von der [[!UICONTROL Data Feed Sync Status]](data-feed-sync-status.md).</li></ul> |
