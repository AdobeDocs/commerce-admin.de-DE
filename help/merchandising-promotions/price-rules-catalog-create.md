...
1. Geben Sie eine Zahl ein, um die **[!UICONTROL Priority]** dieser Regel im Verhältnis zu anderen Regeln festzulegen.
   ...
   >[!NOTE]
   >
   >Die _[!UICONTROL Priority]_ist wichtig, wenn dasselbe Katalogprodukt die Bedingungen für mehr als eine Preisregel erfüllt. Die Regel mit der höchsten Prioritätseinstellung (Prioritäten von der höchsten zur niedrigsten sind 0,1,2,3 …) wird für das Produkt aktiv.
