...
1. Geben Sie eine Zahl ein, um die **[!UICONTROL Priority]** dieser Preisregel in Bezug auf die Aktionseinstellungen anderer Preisregeln zu definieren, die gleichzeitig aktiv sind.
   ...
   Wenn mehrere Regeln oder Coupons für den Warenkorb auf dasselbe Produkt angewendet werden, wird zuerst die Regel mit der höchsten Priorität (niedrigste Zahl) angewendet. Regeln mit derselben Priorität werden nicht kombiniert. Sie werden basierend auf der Regel-ID separat angewendet. Um die Reihenfolge zu steuern, in der Rabatte angewendet werden, weisen Sie eindeutige Prioritäten zu und erwägen Sie die Verwendung [Nachfolgende Preisregeln verwerfen](#step-3-define-the-actions) im Schritt Aktionen , um das Stapeln von Rabatten zu verhindern.
